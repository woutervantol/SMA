...
class Clustersimulation:
    ...
    def __init__(self):
        ...
        ## Maak gasdeeltjes
        gasconverter=nbody_system.nbody_to_si(6*self.total_mass, self.r_cluster)
    ...
    def simulate_timestamp(self, timestamp):
        ...
        self.evolution.evolve_model(timestamp)
...
def plot_energies(Us, Ks, Ts):
    """Plot the potential en kinetic energy."""
...
def star_control(bodies):
    """Get the evolutionary state of the heaviest star."""
